...
/***/ "./public/src/js/modules/notifications.js":
/*!************************************************!*\
  !*** ./public/src/js/modules/notifications.js ***!
  \************************************************/
/*! exports provided: emitNotification */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"emitNotification\", function() { return emitNotification; });\n(() => {\r\n\r\n  const btn = document.querySelector('#notify');\r\n  btn.textContent = `Powiadomienia (${(Notification.permission === 'granted') ? 'on' : 'off'})`;\r\n\r\n  btn.addEventListener('click', () => {\r\n    if (Notification.permission !== 'granted') {\r\n      Notification.requestPermission()\r\n        .then((permission) => {\r\n          if (permission === 'granted') {\r\n            emitNotification();\r\n            btn.textContent = `Powiadomienia (${(Notification.permission === 'granted') ? 'on' : 'off'})`;\r\n          }\r\n        });\r\n    }\r\n  });\r\n  \r\n})();\r\n\r\nconst emitNotification = (title, desc) => {\r\n\r\n  const notification = new Notification('Testowe powiadomienie', {\r\n    body: 'to tylko test',\r\n    icon: '/assets/img/approved.png'\r\n  });\r\n\r\n}\n\n//# sourceURL=webpack:///./public/src/js/modules/notifications.js?");
